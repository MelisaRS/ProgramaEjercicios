...
def abdominales():
     ...
     with mp_pose.Pose(
          ...
          while True:
               ...
               #results = results.resize(frame,(640,480))
               ...
               if results.pose_landmarks is not None:
                    ...
                    if 0 <= x1 < width and 0 <= y1 < height and 0 <= x2 < width and 0 <= y2 < height and 0 <= x3 < width and 0 <= y3 < height:
                         ...
                         if angle >= 170:
                              up = True
                         if up == True and down == False and angle <= 140:
                              down = True
                         if up == True and down == True and angle >= 170:
                              count += 1
                              up = False
                              down = False
                         ...
                         cv2.putText(output, str(int(angle)), (x2 + 30, y2), 1, 1.5, (0, 255, 0), 2)
                         cv2.putText(output, str(count), (10, 50), 1, 3.5, (128, 0, 250), 2)
                         
                         cv2.rectangle(output, (100, 0), (600, 40), (255, 255, 0), -1)
                         cv2.putText(output, "Ejercicios de Abdominales", (110, 30), 1, 2, (128, 0, 250), 2 )
                         
                         cv2.imshow("Ejercicios de Abdominales", output)
                    '''
                    else:
                         cv2.destroyWindow("Ejercicios", output)
                    '''
               ...
               cv2.imshow("Frame Abdominales", frame)
